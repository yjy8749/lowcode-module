  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      ...
      <el-form-item label="菜单类型" prop="type">
        <el-radio-group v-model="formData.type" :disabled="disabledFields.includes('type')">
          <el-radio-button
      ...
      <el-form-item v-if="formData.type === 2" label="组件地址" prop="component">
        <el-input
          ...
          :disabled="disabledFields.includes('component')"
        />
      </el-form-item>
      ...
      <el-form-item v-if="formData.type !== 1" label="权限标识" prop="permission">
        ...
        <el-input
          ...
          clearable
          placeholder="请输入权限标识"
          :disabled="disabledFields.includes('permission')"
        />
      </el-form-item>
...
interface MenuFormProps {
  doCreate?: (data: Partial<MenuApi.MenuVO>) => Promise<void>
  doUpdate?: (data: Partial<MenuApi.MenuVO>) => Promise<void>
}
...
const open = async (
  ...
  id?: number,
  parentId?: number,
  defaultValue?: Partial<MenuApi.MenuVO>,
  _disabledFields?: string[]
) => {
  disabledFields.value = _disabledFields ?? []
