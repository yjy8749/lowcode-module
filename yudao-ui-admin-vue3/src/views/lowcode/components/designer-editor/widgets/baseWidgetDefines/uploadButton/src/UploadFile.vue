...
const props = defineProps({
  ...
  moreFileInfo: propTypes.bool.def(false) // 上传结果是否包含文件信息
})
...
// }
// 文件上传成功
const handleFileSuccess: UploadProps['onSuccess'] = (res: any, file: UploadFile): void => {
  message.success('上传成功')
  // 删除自身
  const index = fileList.value.findIndex((item) => item.url === res.data)
